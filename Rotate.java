public class Rotate{
	...
	private int[][] rotateBlue(int[][] cube){
		...
		tmp[1] = cube[top][1];
		tmp[2] = cube[top][2];
		cube[top][0] = cube[left][2];
		cube[top][1] = cube[left][5];
		cube[top][2] = cube[left][8];
		...
		tmp[1] = cube[bottom][7];
		tmp[2] = cube[bottom][8];
		cube[bottom][6] = tmp2[0];
		cube[bottom][7] = tmp2[1];
		cube[bottom][8] = tmp2[2];
	...
	private int[][] rotateOrange(int[][] cube){
		...
		tmp[1] = cube[top][3];
		tmp[2] = cube[top][6];
		cube[top][0] = cube[left][8];
		cube[top][3] = cube[left][5];
		cube[top][6] = cube[left][2];
	...
	private int[][] rotateYellow(int[][] cube){
		...
		tmp[1] = cube[top][7];
		tmp[2] = cube[top][8];
		cube[top][6] = cube[left][6];
		cube[top][7] = cube[left][7];
		cube[top][8] = cube[left][8];
